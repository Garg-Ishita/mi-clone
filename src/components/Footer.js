...
const Footer = ({footer}) => {
  return (
    ...
    <div>
   <img src="https://cdn-icons-png.flaticon.com/128/1594/1594900.png"/>
    <p><b>Hassle-free replacement</b>
    <br/>
    10-day easy return on mi.com</p>
    </div>
    <div><img src="https://cdn-icons-png.flaticon.com/128/2563/2563814.png"/> <p> <b>100% secure payments</b> <br/> We support Cards, Wallets, EMI and COD</p></div>
    <div> <img src="https://cdn-icons-gif.flaticon.com/6172/6172532.gif"/> <p> <b>Vast service network</b> <br/> 1000 Mi service-centers across 600 cities</p></div>
        </div>
        <div className="PreFooter2">
             ...
             <div className='images'>
                ...
                <img src="https://cdn-icons-png.flaticon.com/128/2504/2504957.png"/>
             </div>
        </div>
