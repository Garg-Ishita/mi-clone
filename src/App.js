...
function App() {
  ...
  return (
    <Router>
      <PreNavbar />
      <Navbar />
      <NavOptions miPhones={a.miPhones} redmiPhones={a.redmiPhones} tv={a.tv} laptop={a.laptop} fitnessAndLifeStyle={a.fitnessAndLifeStyle} home={a.home} audio={a.audio}  accessories={a.accessories}/>
      <Slider start={a.banner.start} />
      <Offers offer={a.offer} />
      <Heading text="STAR PRODUCTS" />
      <Star starProduct={a.starProduct} />
      <Heading text="HOT ACCESSORIES" />
      <HotAccessoriesMenu />
      <Routes>
      <Route exact path="/music"
       element={ <HotAccessories music={a.hotAccessories.music} musicCover={a.hotAccessoriesCover.music}  />}>
      
       </Route>
      <Route exact path="/smartDevice" 
       element={<HotAccessories smartDevice={a.hotAccessories.smartDevice} smartDeviceCover={a.hotAccessoriesCover.smartDevice}  />
       }>
       </Route>
       <Route exact path="/home" element={<HotAccessories home={a.hotAccessories.home} homeCover={a.hotAccessoriesCover.home}  />}>
       
       </Route>

       <Route exact path="/lifestyle" element={<HotAccessories lifeStyle={a.hotAccessories.lifeStyle} lifeStyleCover={a.hotAccessoriesCover.lifeStyle}  />}>
       
       </Route>


       <Route exact path="/mobileAccessories" element={<HotAccessories mobileAccessories={a.hotAccessories.mobileAccessories} mobileAccessoriesCover={a.hotAccessoriesCover.mobileAccessories}  />}>
       
       </Route>
</Routes>
      <Heading text="PRODUCT REVIEW" />
      <ProductReviews productReviews={a.productReviews}/>
